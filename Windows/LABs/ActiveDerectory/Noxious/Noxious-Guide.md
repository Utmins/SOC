...
1. Перед тем, как мы приступик к анализу `pcap` файла посредством **Wireshark**, нам желательно узнать, какие вообще протоколы присутсвую в данном файле.
...
- Итак, переходим к сперва начнем с `upd.port == 5355` - порт протокла LLMNR по-умолчанию.
