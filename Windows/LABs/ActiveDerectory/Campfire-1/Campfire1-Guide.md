...
(нужен отступ)   Дело в том, что название службы (service) как правило не содержит в своем наименование знак $, так как он присущ рабочим станция (DC01$ - Domain Contorller или FORELA-WKSTN001$ - имя хоста)
