...
&nbsp;&nbsp;&nbsp;&nbsp;Дело в том, что название службы (service) как правило не содержит в своем наименование символ "$", так как он присущ рабочим станция (DC01$ - Domain Contorller или FORELA-WKSTN001$ - имя хоста)
...
&nbsp;&nbsp;&nbsp;&nbsp;Ну, тут все просто  -   смотрим поле с **TimeStamp** или **TimeCreated**
